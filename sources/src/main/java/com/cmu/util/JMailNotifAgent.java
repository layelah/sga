...
/* COnstrutor */
    ...
    public JMailNotifAgent(String mailAgent, String mailInterne, String nomAgent, String nomSH, int numDemande, Date dateDemande, Date dateDebut, Date dateFin) {
...
/* Getters and Setters*/
    ...
    public void setMailSH(String mailInterne) {
        this.mailInterne = mailInterne;
    }
    ...
    private static Message prepareMessage(Session session, String monCompte, String destinataire) {
         ...
         try {
            ...
            Logger.getLogger(JMailNotifAgent.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;   
    }
