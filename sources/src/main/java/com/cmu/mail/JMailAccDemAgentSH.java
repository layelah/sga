 ...
 * @author issathiam
 */
public class JMailAccDemAgentSH {
...
/* COnstrutor */
    ...
    public JMailAccDemAgentSH(String typeConges, String mailRH, String mailSH, String mailAgent, String mailInterne, String nomAgent, String nomSH, int numDemande, String dateValidation, String dateDebut, String dateFin) {
 ...
 /********************************************************************************************
 *Préparation et Envoie du Mail d'acceptation de la demande par le Supérieur Hierarchique
  ...
  ********************************************************************************************/
   ...
   /********************************************************************************************************/ 
    private Message prepareMailToAgent(Session session, String emailInterne, String emailToAgent) {
        ...
        String subject = "Acceptation par le Supérieur Hierarchique de la demande d'absence N° " + this.getNumDemande();
        String text = "Bonjour "+this.getNomAgent()+" \n\n"
                + " Votre demande d'absence "+this.typeConges+" du "+this.getDateDebut() +" au "+this.getDateFin() +" est acceptée à la date du "+this.getDateValidation()+ " par votre supérieur hiérarchique "+this.getNomSH()+"." +" \n \n"
  ...
  ********************************************************************************************/
    ...
    private Message prepareMailToSH(Session session, String emailInterne, String emailSH) {
        ...
        String text = "Bonjour "+this.getNomSH()+" \n\n"
                + " Vous avez accepté la demande d'absence "+this.typeConges+" de votre Agent "+this.getNomAgent()+" pour la période du "+this.getDateDebut() +" au "+this.getDateFin()+ "." +" \n \n"
                + "La demande est en attente de validation au niveau des Ressources Humaines." +"\n \n"
 ...
 public void sendMailToRH(String emailToRH, String emailInterne, String mdp, String smtpHost, String smtpPort) throws Exception{
  ...
  /********************************************************************************************/
    private Message prepareMailToRH(Session session, String emailInterne, String emailRH) {
        ...
        String text = "Bonjour les Ressources Humaines \n\n"
                ...
                + "La demande a été acceptée à la date du "+this.getDateValidation()+ " par son supérieur hiérarchique "+this.getNomSH()+"." +" \n \n"
