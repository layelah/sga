...
/* COnstrutor */
    ...
    public JMailRefDemRH(String typeConges, String mailSH, String mailAgent, String mailInterne, String nomAgent, String nomSH, int numDemande, String dateRefus, String dateDebut, String dateFin) {
    ...
    /********************************************************************************************
 *Préparation et Envoie du Mail de refus de la demande par le Service des Ressources Humaines
  ...
  ********************************************************************************************/
   ...
   /********************************************************************************************************/ 
    ...
    private Message prepareMailToAgent(Session session, String emailInterne, String emailToAgent) {
        ...
        String subject = "Refus par le Service RH de la demande d'absence N° " + this.getNumDemande();
        String text = "Bonjour "+this.getNomAgent()+" \n\n"
                + " Votre demande d'absence "+this.typeConges+" du "+this.getDateDebut() +" au "+this.getDateFin() +" a été refusée à la date du "+this.getDateRefus()+ " par le Service RH." +" \n \n"
         ...
         try {
            ...
            Logger.getLogger(JMailRefDemRH.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;   
    }
  ...
  ********************************************************************************************/
    ...
    private Message prepareMailToSH(Session session, String emailInterne, String emailSH) {
        ...
        String text = "Bonjour "+this.getNomSH()+" \n\n"
                + " La demande d'absence "+this.typeConges+" de votre Agent "+this.getNomAgent()+" pour la période du "+this.getDateDebut() +" au "+this.getDateFin() +" est refusée à la date du "+this.getDateRefus()+ " par le Service RH." +" \n \n"
