...
/* COnstrutor */
    ...
    public JMailAccDemDG(String typeConges, String mailDG, String mailRH, String mailSH, String mailAgent, String mailInterne, String nomAgent, String nomSH, int numDemande, String dateValidation, String dateDebut, String dateFin) {
    ...
    /********************************************************************************************
 *Préparation et Envoie du Mail d'acceptation de la demande par le Directeur Général
  ...
  ********************************************************************************************/
   ...
   /********************************************************************************************************/ 
    private Message prepareMailToAgent(Session session, String emailInterne, String emailToAgent) {
        ...
        String subject = "Acceptation du Directeur Général de la demande d'absence N° " + this.getNumDemande();
        String text = "Bonjour "+this.getNomAgent()+" \n\n"
                + " Votre demande d'absence "+this.typeConges+" du "+this.getDateDebut() +" au "+this.getDateFin() +" est acceptée à la date du "+this.getDateValidation()+ " par le Directeur Général." +" \n \n"
         ...
         try {
            ...
            Logger.getLogger(JMailAccDemDG.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;   
    }
    ...
    /********************************************************************************************
 *Préparation et Envoie du Mail d'acceptation de la demande par le Directeur Général
 * Destinataire: Sup&rieur Hierarchique
 * 
  ********************************************************************************************/
    ...
    private Message prepareMailToSH(Session session, String emailInterne, String emailSH) {
        ...
        String text = "Bonjour "+this.getNomSH()+" \n\n"
                + " La demande d'absence "+this.typeConges+" de votre Agent "+this.getNomAgent()+" pour la période du "+this.getDateDebut() +" au "+this.getDateFin() +" est acceptée à la date du "+this.getDateValidation()+ " par le Directeur Général." +" \n \n"
  ...
  ********************************************************************************************/
  ...
  /********************************************************************************************/
    private Message prepareMailToRH(Session session, String emailInterne, String emailRH) {
        ...
        String text = "Bonjour  \n\n"
                + " La demande d'absence "+this.typeConges+" de l'Agent "+this.getNomAgent()+" pour la période du "+this.getDateDebut() +" au "+this.getDateFin() +" est acceptée à la date du "+this.getDateValidation()+ " par le Directeur Général." +" \n \n"
