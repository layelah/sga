...
@Named("archivageAbs")
@SessionScoped
public class ArchivageAbsBean extends BaseCRUDBean {
    ...
    public ArchivageAbsBean() {
        super(WebRacineEnum.RH, "archivageAbs");   
    }

    public ArchivageAbsBean(AuthentificationBean auth, TableValeurService tvSrv, ServiceSql srv, AgentService agtSrv, Date dateDebut, Date dateFin, String nomDirection, List<Absence> listeEtat) {
        this.auth = auth;
        this.tvSrv = tvSrv;
        this.srv = srv;
        this.agtSrv = agtSrv;
...
//end clear`
    ...
    public void afficheEtats() throws SQLException{
        ...
        try {
            ...
            Logger.getLogger(ArchivageAbsBean.class.getName()).log(Level.SEVERE, null, ex);
        }
