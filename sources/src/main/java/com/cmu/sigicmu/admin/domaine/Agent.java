...
public class Agent extends PersonnePhysique {
    ...
    public Date getDatePriseFonction1() {
        return JIDate.ajouterJour(datePriseFonction, 1);
    }
    ...
    public boolean estDG() {
     ...
     public boolean estCB() {
        return (this.getFonction() != null && (this.getFonction().getCode().equals(FonctionEnum.ChefBureau.toString())));
    }
