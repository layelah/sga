...
public List<DemandePermissionAbsence> getEtatDemAbsenceBySearch(Integer idService, Date dateDebut, Date dateFin) {
        List<DemandePermissionAbsence> resultat = new ArrayList<DemandePermissionAbsence>();
        
        if (idService == 16){
            
            resultat = getEtatDemAbsenceAll();
        ...
        resultat = (List<DemandePermissionAbsence>)q.getResultList();
        //return (List<DemandePermissionAbsence>)q.getResultList();
